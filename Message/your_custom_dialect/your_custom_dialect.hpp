/** @file
 *	@brief MAVLink comm protocol generated from your_custom_dialect.xml
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_get_attitude_battery.hpp"
